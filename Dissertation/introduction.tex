...
\begin{enumerate}
    \item  Адаптирован метод Монте-Карло на Марковской цепи для моделирования спиновых систем с динамической геометрией. Метод позволяет изучать систему, генерируя новые геометрические состояния (блуждания без самопересечений) и спиновые переменные.   
    \item  Была исследована численно модель Изинга на квадратной и кубических решетках. 
     \item 
     \item 
     \item 
\end{enumerate}
