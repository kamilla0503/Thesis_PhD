...
\newtotcounter{thesischapter}
\newtotcounter{thesisappendix}

\newif\ifinthesisappendix
\inthesisappendixfalse

\makeatletter
\pretocmd{\appendix}{\inthesisappendixtrue}{}{}

\pretocmd{\@chapter}{%
	\ifinthesisappendix
	\stepcounter{thesisappendix}%
	\else
	\stepcounter{thesischapter}%
	\fi
}{}{}
\makeatother
...
\includepdf[pages=-]{Dissertation/title.pdf}
...
\include{Dissertation/introduction1}    % Введение
...
%\begin{refsection}[biblio/references.bib]
%	\nocite{*}
%	\printbibliography[
	%keyword=own,
